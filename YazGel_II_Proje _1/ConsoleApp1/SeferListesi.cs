...
namespace YazGel_II_Proje__1
{
    class SeferListesi
    {
        ...
        public void Ekle(string seferNo, string saat, string guzergah, string kapasite, string tarih,string plaka,string kaptan)
        {
        ...
        public SeferBilgisiDugum dugumCek(string seferNo)
        {
            SeferBilgisiDugum temp;
            temp = head;
